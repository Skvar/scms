...
//----------------------------------------------------	
			...
			{
				$uinfo = $this->LoadRow("SELECT * FROM ".static::$TableName." WHERE id=".$this->objectID);
	...
	//----------------------------------------------------
			...
			{
				$uinfo = $this->LoadData("SELECT * FROM ".static::$TableName." WHERE login='".$login."'");
	...
	//--------------------------------------------------------------------------------
			private function SaveStats($userid,$ip,$hash,$useragree)
			{
				...
				$this->Query("UPDATE ".static::$TableName." SET hash='".$hash."',lastlogin='".date("Y-m-d")."',lastip='$userip', agree=$useragree WHERE id=$id");
